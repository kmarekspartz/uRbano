  ...
  if (method == "web_mercator") {
    ...
    transform_NAD_utm <- function(rad) {
      ...
      if (longitude >= (-126) && longitude < (-120)) {
        ...
        return(sf::st_transform(rad, crs = 26912))
      } else if (longitude >= (-108) && longitude < (-102)) {
        return(sf::st_transform(rad, crs = 26913))
      } else if (longitude >= (-102) && longitude < (-96)) {
        return(sf::st_transform(rad, crs = 26914))
      } else if (longitude >= (-96) && longitude < (-90)) {
        return(sf::st_transform(rad, crs = 26915))
      } else if (longitude >= (-90) && longitude < (-84)) {
        return(sf::st_transform(rad, crs = 26916))
      } else if (longitude >= (-84) && longitude < (-78)) {
        return(sf::st_transform(rad, crs = 26917))
      } else if (longitude >= (-78) && longitude < (-72)) {
        return(sf::st_transform(rad, crs = 26918))
      } else if (longitude >= (-72) && longitude < (-66)) {
        return(sf::st_transform(rad, crs = 26919))
      } else if (longitude >= (-180) && longitude < (-174)) {
        return(sf::st_transform(rad, crs = 26901))
      } else if (longitude >= (-174) && longitude < (-168)) {
        return(sf::st_transform(rad, crs = 26902))
      } else if (longitude >= (-168) && longitude < (-162)) {
        return(sf::st_transform(rad, crs = 26903))
      } else if (longitude >= (-162) && longitude < (-156)) {
        return(sf::st_transform(rad, crs = 26904))
      } else if (longitude >= (-156) && longitude < (-150)) {
        return(sf::st_transform(rad, crs = 26905))
      } else if (longitude >= (-150) && longitude < (-144)) {
        return(sf::st_transform(rad, crs = 26906))
      } else if (longitude >= (-144) && longitude < (-138)) {
        return(sf::st_transform(rad, crs = 26907))
      } else if (longitude >= (-138) && longitude < (-132)) {
        return(sf::st_transform(rad, crs = 26908))
      } else if (longitude >= (-132) && longitude < (-126)) {
        return(sf::st_transform(rad, crs = 26909))
      } else {
